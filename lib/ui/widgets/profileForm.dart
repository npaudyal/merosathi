...
class _ProfileFormState extends State<ProfileForm> {
  ...
  String name, country, heightP, gender, community, interestedIn, salary, gotra, bio, job, religion;
  String education;
  DateTime age;
                              ...
                              Container(
                                child: Stack(
                                  children: <Widget>[
                                    ...
                                    Container(
                                      padding:
                                          EdgeInsets.only(right: 150, top: 90),
                                      child: Text(
                                        'Hello',
                ...
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(20),
                                    border: Border.all(
                                        color: Colors.pink.shade300, width: 7),
                      ...
                      Center(
                        child: Text(
                          ' "Having a profile Picture increases the chance of getting a match"  - CEO ',
                          style: GoogleFonts.roboto(
                            color: Colors.black,
                            fontSize: 14,
                            fontStyle: FontStyle.italic,
